...
<div class="container">
    ...
    <div class="panel">
        ...
        <div class="panel-body">
    		...
    		<?php
    		   $data = mysqli_query($koneksi,"select * from pelanggan, transaksi where transaksi_pelanggan=pelanggan_id 
    		   	order by transaksi_id desc limit 10");
    		   $no = 1;
