...
// menghitung harga laundey, harga perkilo x berat cucian
$harga = $berat * $harga_per_kilo['harga_per_kilo'];


// update data transaksi
mysqli_query(koneksi,"update transaksi set transaksi_pelanggan='$pelanggan', transaksasi_harga='$harga', transaksi_berat='$berat',transaksi_tgl_selesai='$tgl_selesai', transaksi_status='$status' where transaksi_id='$id'");
...
mysqli_query($koneksi,"detele from pakaian where pakaian_transaksi='$id'");
