		...
		<div class="col-md-8 col-md-offset-2">
			...
			while($t=mysqli_fetch_array($transaksi)){
				...
				<form method="post" action="transaksi_update.php">
					<!-- menyimpan id transaksi yang di edit dallam form hidden berikut -->
					...
					<table class="table table-bordered table-striped">
						...
						<div class="form-group alert alert-info">
							...
							<select class="form-control" name="status" required="required">
								...
								<option <?php if($t['transaksi_status']=="1"){echo "selected='selected'";} ?> value="0">DI CUCI</option>

								<option <?php if($t['transaksi_status']=="2"){echo "selected='selected'";} ?> value="0">SELESAI</option>
